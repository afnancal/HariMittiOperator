...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        int defaultBaseColor = ContextCompat.getColor(context, R.color.colorTextNormal);
        int defaultHighlightColor = defaultArray.getColor(1, 0);
        int defaultErrorColor = ContextCompat.getColor(context, R.color.colorRed);
        ...
        disabledColor = ContextCompat.getColor(context, R.color.colorTextNormal);
